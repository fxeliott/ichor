...
export function VerdictBanner({
  ...
  return (
    <m.section
      ...
      className="relative overflow-hidden rounded-3xl border border-[var(--color-border-default)] bg-gradient-to-br from-[var(--color-bg-elevated)] via-[var(--color-bg-surface)] to-[var(--color-bg-elevated)] p-7 backdrop-blur-2xl"
    >
      <div
        aria-hidden
      ...
      <h2 className="mt-3 font-serif text-3xl leading-tight text-[var(--color-text-primary)]">
        Biais{" "}
        ...
        {v.conviction.band}) ·{" "}
        <span className="text-[var(--color-text-secondary)]">{v.regimeLabel}</span> ·{" "}
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-3">
        {[v.caractere, v.confiance, v.confluence].map((part, i) => (
          <div
            key={i}
            className="rounded-xl border border-[var(--color-border-subtle)] bg-[var(--color-bg-base)]/40 p-4"
          >
      ...
      <div className="mt-4 rounded-xl border border-[var(--color-border-subtle)] bg-[var(--color-bg-base)]/40 p-4">
        <p className="text-[10px] uppercase tracking-widest text-[var(--color-text-muted)]">
          À surveiller
        </p>
        <div className="mt-1.5 grid gap-2 text-sm text-[var(--color-text-secondary)] md:grid-cols-2">
          <p>
            <span className="text-[var(--color-text-muted)]">Catalyseur · </span>
            {v.watch.catalyst ?? "aucun événement à fort impact à l'horizon"}
          </p>
          <p>
            <span className="text-[var(--color-text-muted)]">Invalidation · </span>
