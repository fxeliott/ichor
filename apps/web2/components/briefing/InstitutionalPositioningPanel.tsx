          ...
          <ul className="space-y-2.5">
            {tffRows.map(([label, net, dw], i) => {
              ...
              return (
                ...
                >
                  <span className="w-20 shrink-0 font-mono text-xs text-[var(--color-text-secondary)]">
                    {label}
                  </span>
                  <div className="relative h-2 flex-1">
                    ...
                    <m.div
                      ...
                      className={`absolute top-0 h-full rounded-full ${
                        pos ? "left-1/2 bg-[var(--color-bull)]" : "right-1/2 bg-[var(--color-bear)]"
                      }`}
                    />
                  </div>
                  <span
                  ...
                  >
                    {signed(net)}
                    <span className="text-[var(--color-text-muted)]">{deltaLabel(dw)}</span>
                  </span>
                </m.li>
              );
            })}
