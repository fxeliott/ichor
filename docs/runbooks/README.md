...
| ID  | File                                                                    | Trigger                                              |
| --- | ----------------------------------------------------------------------- | ---------------------------------------------------- |
| 001 | [Hetzner host down](RUNBOOK-001-hetzner-down.md)                        | No SSH, no HTTPS — full host outage                  |
...
| 004 | [R2 bucket inaccessible](RUNBOOK-004-r2-down.md)                        | Cloudflare R2 EU outage / credentials revoked        |
...
| 012 | [CF quick tunnel down](RUNBOOK-012-cloudflare-quick-tunnel-down.md)     | Cloudflare Tunnel `claude-runner.fxmilyapp.com` down |
